<x-app-layout>
            ...
            <div class="thesis-show-content-section">
                ...
                <div class="thesis-document-box">
                    ...
                    <div class="thesis-document-actions">
                        ...
                        {{-- View PDF --}}
                        <a href="#thesis-request-pdf-preview"
                        ...
                        {{-- Download --}}
                        @if ($status === 'approved' && $thesisRequest->thesis_id)

                            <a href="{{ route('student.thesis.download', $thesisRequest->thesis_id) }}"
                                class="thesis-download-button">
                ...
                {{-- PDF PREVIEW --}}
                <div class="thesis-pdf-preview-box"
                    id="thesis-request-pdf-preview">
                    ...
                    <div class="thesis-pdf-frame-wrapper">
                        ...
                        <iframe
                            src="{{ route('student.thesis_requests.view-request-pdf', $thesisRequest) }}"
                            title="Thesis Request PDF Preview"
            ...
            <div class="thesis-show-content-section">
                ...
                <div class="thesis-section-heading">
                    ...
                    <div>
                        ...
                        <p>
                            General information about this thesis request.
                        </p>
                    ...
                    <div class="thesis-form-group">
                        ...
                        <div class="thesis-form-control">
                            ...
                            {{ $thesisRequest->reviewer?->name
                                ?? ($thesisRequest->reviewer?->username ?? 'N/A') }}
            ...
            <div class="thesis-show-content-section">
                ...
                <div class="thesis-section-heading">
                    ...
                    <div>
                        ...
                        <p>
                            Abstract submitted with this thesis request.
                        </p>
            ...
            <div class="thesis-show-content-section">
                ...
                <div class="thesis-section-heading">
                    ...
                    <div>
                        ...
                        <p>
                            Description submitted with this thesis request.
                        </p>
    ...
    <style>
        ...
        .thesis-show-status.status-rejected {
            background: #fff1f1;
            color: #dc3545;
        ...
        [data-bs-theme="dark"] .thesis-download-button {

            color: #9b7bea !important;

            border-color: #9b7bea !important;

        }


        [data-bs-theme="dark"] .thesis-download-button:hover {
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pdfPreview =
                document.getElementById('thesis-request-pdf-preview');
