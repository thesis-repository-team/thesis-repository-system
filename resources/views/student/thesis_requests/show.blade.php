...
<div class="dashboard-content thesis-show-page">
    ...
    @php
        $isApprovedThesisRequest =
            $thesisRequest &&
            strtolower($thesisRequest->status ?? '') === 'approved';
    @endphp

    @if ($isApprovedThesisRequest)
        ...
        <div class="thesis-show-card">
            ...
            <div class="thesis-show-content-section">
                ...
                <div class="thesis-information-form">
                    ...
                    <div class="thesis-form-group">
                        <span class="thesis-form-label">Status</span>
                        <div class="thesis-form-control">
            ...
            <div class="thesis-show-content-section">
                ...
                <div class="thesis-document-box">
                    ...
                    <div class="thesis-document-actions">
                        ...
                        <a
                            href="#thesis-request-pdf-preview"
                ...
                >
                    ...
                    <div class="thesis-pdf-frame-wrapper">
                        ...
                        <iframe
                            ...
                            title="Approved Thesis Request PDF Preview"
    ...
    @else
        ...
        <div class="thesis-empty-state">
            ...
            <h2>Thesis Request Not Available</h2>

            <p>
                This thesis request has not been approved yet,
                or the thesis request could not be found.
            </p>
