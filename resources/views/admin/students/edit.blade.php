<x-app-layout>
    ...
    <style>
        ...
        [data-bs-theme="dark"] {
            ...
            --student-text: #ffffff;
            --student-text-secondary: #ffffff;
            --student-text-muted: #ffffff;

            --student-border: #333333;
            --student-border-soft: #333333;

            --student-placeholder: #777777;
        ...
        [data-bs-theme="dark"] .student-form-control {
        ...
        [data-bs-theme="dark"] .student-form-control:focus {
