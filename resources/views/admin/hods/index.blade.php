<x-app-layout>
    ...
    <div class="dashboard-content">
        ...
        <div class="hod-results-wrapper">
            ...
            <div id="adminHodTable" class="thesis-card-grid">
    ...
    .hod-mobile-search-button {
        ...
        border: 1px solid var(--hod-border-soft);
    ...
    /* =========================================================
       HOD CARD GRID
       IMPORTANT:
       NO BOOTSTRAP COL WRAPPER REQUIRED
    ========================================================== */
    ...
    .hod-spinner {
        ...
        border: 2px solid var(--hod-border-soft);

        border-top-color: var(--hod-primary);

        border-radius: 50%;

        animation: hodSpin .7s linear infinite;
    }
