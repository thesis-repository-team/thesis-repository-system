                ...
                <form action="{{ route('admin.hods.update', $hod->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="full_name"
                            class="form-control @error('full_name') is-invalid @enderror" value="{{ $hod->full_name }}"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="username"
                            ...
                            value="{{ old('username', $hod->user->username) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="started_year"
                            ...
                            value="{{ old('started_year', $hod->started_year) }}" placeholder="2025" required>
