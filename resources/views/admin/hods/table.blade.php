        ...
        <div class="admin-student-card">
            ...
            <div class="admin-student-card-body">
                ...
                <div class="admin-student-card-top">
                    ...
                    @if ($hod->is_active)
                        <span class="admin-student-permission admin-student-permission-allowed" title="HoD is Active">
                    ...
                    @else
                        <span class="admin-student-permission admin-student-permission-denied" title="HoD is Inactive">
                ...
                <div class="admin-student-card-action">
                    ...
                    <a href="{{ route('admin.hods.edit', $hod->id) }}" class="admin-student-edit-button"
                        data-tooltip="Edit HoD" aria-label="Edit HoD">
                    ...
                    @foreach ($hods as $hod)
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="hod-table-email" title="{{ $hod->user->email ?? 'N/A' }}">
                            ...
                            <td>
                                ...
                                <span class="hod-table-department" title="{{ $hod->department->name ?? 'N/A' }}">
                            ...
                            <td>
                                ...
                                <div class="hod-table-actions">
                                    ...
                                    <a href="{{ route('admin.hods.edit', $hod->id) }}" class="hod-table-edit-button"
                                        data-tooltip="Edit HoD" aria-label="Edit HoD">
