<x-app-layout> 
    ...
    <div class="container mt-6">
        ...
        <div class="d-flex gap-2">
            <form action="{{ route('hod.thesis_requests.approve', $thesisRequest->id) }}" method="POST" class="w-100">
                @csrf
                <button class="btn btn-success w-100 btn-sm">Approve</button>
            </form>

            <form action="{{ route('hod.thesis_requests.reject', $thesisRequest->id) }}" method="POST" class="w-100">
                @csrf
